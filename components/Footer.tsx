        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="mt-4 flex items-center gap-4">
              <a href="https://wa.me/21612345678" className="text-slate-400 hover:text-emerald-400 transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li className="flex items-center gap-2">
                <span>WhatsApp:</span>
                <a href="https://wa.me/21612345678" className="text-emerald-400 hover:underline">+216 12 345 678</a>
              </li>
              <li className="flex items-center gap-2">
                <span>Email:</span>
